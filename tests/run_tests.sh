...
test_execution_modes() {
    ...
    run_test "Mode Fork" "${PARENT_DIR}/orchestrator.sh -f tests/scenarios/test_light.sh"
    run_test "Mode Thread" "${PARENT_DIR}/orchestrator.sh -t tests/scenarios/test_light.sh"
    run_test "Mode Subshell" "${PARENT_DIR}/orchestrator.sh -s tests/scenarios/test_light.sh"
}
...
test_scenarios() {
    ...
    run_test "Scénario Léger" "${PARENT_DIR}/orchestrator.sh -f tests/scenarios/test_light.sh"
    run_test "Scénario Moyen" "${PARENT_DIR}/orchestrator.sh -f tests/scenarios/test_medium.sh"
    run_test "Scénario Lourd" "${PARENT_DIR}/orchestrator.sh -f tests/scenarios/test_heavy.sh"
}
